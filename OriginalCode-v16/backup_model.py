...
def my_cross_entropy(y_pred, y,has_weight=False, weight_length=1, weight_max=10,if_CE=False,my_weight=None):
    '''
...
self.knowledge_type_embedding = nn.Embedding(100, self.emb_size, padding_idx=0)
