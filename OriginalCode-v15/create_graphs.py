...
### load datasets
    ...
    # real graphs
        ...
        if args.dataset_type == "2" or args.dataset_type == "2-normalize" or args.dataset_type == '15-13':
            args.max_prev_node = 6
            args.max_node_value_num = 6
        elif args.dataset_type == "54" or args.dataset_type =='50-normalize':
            args.max_prev_node = 20
            args.max_node_value_num = 42
            args.node_loss_w = 1.0
            args.node_loss_w_list = [1, 2, 0.1, 1.5, 0.25] # [type_loss, index_loss, int_and_float_v_loss[0], int_and_float_v_loss[1], string_loss]
            args.edge_loss_w = 10.0
            ...
            args.max_prev_node = 150
        elif args.dataset_type == "500-50-normalize" or args.dataset_type == "468-50-normalize":
            args.max_prev_node = 40
            args.max_node_value_num = 272
            args.node_loss_w = 1.0
            args.node_loss_w_list = [1, 2, 1.5, 1.5, 0.25] # [type_loss, index_loss, int_and_float_v_loss[0], int_and_float_v_loss[1], string_loss]
            args.edge_loss_w = 10.0
    # TODO: args.max_edge_feature_num update

        args.node_rules = rule_matrix
        if args.leaf_node_idx_list is None:
            args.leaf_node_idx_list = [n for n in range(rule_matrix.shape[0]) if not rule_matrix[n,:].any()]
