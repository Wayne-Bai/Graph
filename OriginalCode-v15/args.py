...
class Args():
    def __init__(self):
        ...
        self.epochs = 2 # now one epoch means self.batch_ratio x batch_size
        ...
        # self.loss_type = "mse"
        self.loss_type = "CE"
        self.node_loss_w = 1.0
        self.node_loss_w_list = [1, 2, 1.5, 100, 0.5] # [type_loss, index_loss, int_and_float_v_loss[0], int_and_float_v_loss[1], string_loss]
        self.edge_loss_w = 10.0
