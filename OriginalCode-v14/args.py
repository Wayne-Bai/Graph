...
class Args():
    def __init__(self):
        ...
        self.test_total_size = 2 # To make things simple, set total_size = batch_size
        self.num_layers = 4
        ...
        self.epochs = 600 # now one epoch means self.batch_ratio x batch_size
        self.epochs_test_start = 400
        self.epochs_test = 50
        self.epochs_log = 10
        ...
        self.node_loss_w_list = [1, 5, 0.001, 10, 0.25] # [type_loss, index_loss, int_and_float_v_loss[0], int_and_float_v_loss[1], string_loss]
        self.edge_loss_w = 5
        ...
        self.graph_save_path = self.dir_input+'graphs_50/'
