...
class Graph_sequence_sampler_pytorch(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print("adj_copy dim: {}".format(adj_copy.ndim))
        ...
        print("raw_node_f_batch dim: {}".format(raw_node_f_batch.ndim))

        raw_edge_f_batch = self.construct_edge_f(edge_dict, node_num_list) # Dim: N * N * EF

        print("raw_edge_f_batch dim: {}".format(raw_node_f_batch.ndim))
        ...
        print("adj_encoded dim: {}".format(adj_encoded.ndim))
        ...
        print("edge_f_encoded dim: {}".format(edge_f_encoded.ndim))
        ...
        print("raw_node_f: {}".format(raw_node_f_batch))
